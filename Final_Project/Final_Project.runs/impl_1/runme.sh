...
HD_PWD='D:/Program_Files/CHULA/Y3TERM1/HW_Lab/HW-SYN-LAB-FINAL-PROJECT-2022/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system2.tcl -notrace
