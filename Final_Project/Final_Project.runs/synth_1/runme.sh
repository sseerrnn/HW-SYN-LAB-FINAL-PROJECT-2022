...
HD_PWD='D:/Program_Files/CHULA/Y3TERM1/HW_Lab/HW-SYN-LAB-FINAL-PROJECT-2022/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system2.tcl
